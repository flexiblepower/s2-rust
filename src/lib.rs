...
//! Specifically, the S2 type definitions in [`common`] and the control type specific modules are all generated. That documentation
//! is often still helpful, but may be poorly formatted or incomplete.
//!
